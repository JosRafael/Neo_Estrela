...
const Fortune = () => {
  ...
  const alternarEstrategias = () => {
    ...
    const mensagem = turboAtivo
      ? `Tourinho tá pagando até ${horaFormatada} entrem ${novaEstrategiaTurbo.multiplicador}x Turbo e ${novaEstrategiaNormal.multiplicador}x Normal`
      : `Tourinho tá pagando até ${horaFormatada} entrem ${novaEstrategiaNormal.multiplicador}x Normal e ${novaEstrategiaTurbo.multiplicador}x Turbo`;
  ...
  return (
    <Container>
      ...
      <General>
        ...
        <Main>
          <MainName><AnalystName>Kleber Magalhães</AnalystName></MainName>
          <MainBody>
            {isTyping ? (
      ...
      <IframeComponent link={LinkGame[9].link} />   
      </Container>
  );
};
