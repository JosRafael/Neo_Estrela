...
const Rabbit = () => {
  ...
  const alternarEstrategias = () => {
    ...
    const mensagem = turboAtivo
      ? `Coelho tá pagando até ${horaFormatada} entrem ${novaEstrategiaTurbo.multiplicador}x Turbo e ${novaEstrategiaNormal.multiplicador}x Normal`
      : `Coelho tá pagando até ${horaFormatada} entrem ${novaEstrategiaNormal.multiplicador}x Normal e ${novaEstrategiaTurbo.multiplicador}x Turbo`;
  ...
  return (
    <Container>
      ...
      <General>
        ...
        <Main>
          <MainName><AnalystName>Fernanda Almeida</AnalystName></MainName>
          <MainBody>
            {isTyping ? (
      ...
      <IframeComponent link={LinkGame[8].link} />
    </Container>
  );
};
