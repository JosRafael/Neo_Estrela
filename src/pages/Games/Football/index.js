...
import PanelRoleta from "../FootballPanel";
...
const Football = () => {
  ...
  const estrategias = [
    (tempoExpiracao) => (<span>Entrada confirmada na cor 🟦 até <HighlightedText>2 proteções</HighlightedText>, válido até {tempoExpiracao}</span>),
    (tempoExpiracao) => (<span>Entrada confirmada na cor 🟥 até <HighlightedText>2 proteções</HighlightedText>, válido até {tempoExpiracao}</span>)
];
  ...
  return (
    <Container>
      ...
      <General>
        ...
        <Main>
          <MainMsg>
            <MainName>Marcela Matias</MainName>
            {isLoading ? (
      ...
      <IframeComponent link={LinkGame[4].link} />
