...
import roletaImage from '../../assets/roleta-start.png';
...
const PromoWheel = ({ show, onClose }) => {
  ...
  const {setModalRoletaPromo} = useContext(AuthContext)
  ...
  const handleSpin = () => {
    ...
    setTimeout(() => {
      ...
      setModalRoletaPromo(true) // Redireciona para a rota /promotional
    }, 6500);
  };
